...
def setup(exp):
    ...
    mm1 = ali.MatchMaker("a", "b", "c", "d", exp=exp, admin_pw="test", id="large_match", counter=counter1)
    mm2 = ali.MatchMaker("a", "b", exp=exp, admin_pw="test", id="small_match", counter=counter2)
