...
sys.path.insert(0, os.path.abspath("../../src/alfred3_interact"))


# -- Project information -----------------------------------------------------

project = "alfred3_interact"
...
html_theme_options = {
    "repository_url": "https://github.com/jobrachem/alfred3-interact",
    "use_repository_button": True,
}

html_title = "alfred3_interact"
